...
output_shapefile = os.path.join(input_dir, "USA_continous_states_gridpoints_0.5degree.shp")
...
output_figure = os.path.join(input_dir, "USA_continous_states_gridpoints_0.5degree.jpg")
