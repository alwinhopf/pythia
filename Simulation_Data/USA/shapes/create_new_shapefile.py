...
input_dir = "C:/pythia/Simulation_Data/USA/shapes"

print("Step 1: Reading the shapefile...")
shapefile_path = os.path.join(input_dir, "cb_2022_us_nation_20m.shp")
...
output_shapefile = os.path.join(input_dir, "USA_gridpoints.shp")
...
plt.title("1 * 1 Degree Grid Points Over Shapefile")
plt.xlabel("Longitude")
plt.ylabel("Latitude")

# Save the plot as a JPEG file
output_figure = os.path.join(input_dir, "shapefile_grid_points.jpg")
