...
AEZ<-st_read("C:/pythia/Simulation_Data/USA/shapes/contiguous_us2.shp")
...
ggsave(plot = plot_TOT_PROD, filename = "C:/pythia/Simulation_Data/OUTPUT/USA_carinata_rf_highN_RCOM.jpeg", dpi=300,
       height = 11,width = 10)
plot_TOT_PROD
