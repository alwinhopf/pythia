...
raw_pythia_output <- read.csv("C:/pythia/Simulation_Data/OUTPUT/Sri_Lanka/Maize/Sri_Lanka_maize_rf_highN/SL_maize_rf_highN.csv")
...
ggsave(plot = plot_TOT_PROD, filename = "C:/pythia/Simulation_Data/OUTPUT/Sri_Lanka_maize_rf_highN_Yield.jpeg", dpi=300,
       height = 11,width = 10)
plot_TOT_PROD
